      ...
      sent
        ? h("div",{style:{padding:28,textAlign:"center"}},
            ...
            h("div",{style:{fontSize:13,color:C.gray,lineHeight:1.7,marginBottom:20}},
              "Send "+form.name+" this invitation:

1. Subscribe at truebalancefitness.com
2. Download the app at: your-app-url.vercel.app
3. On iPhone: tap Share → Add to Home Screen
4. Sign up with this email: "+form.email+"
5. Create your password when prompted"
            ),
...
Welcome to True Balance Fitness! Here is how to get started:

1. Subscribe: [ADD STRIPE LINK]
2. Open your app: [ADD YOUR VERCEL URL]
3. On iPhone: tap the Share button → Add to Home Screen
4. Sign up with: "+form.email+"
5. Create your own password

See you at your next session!
— Anthony Anderson, CPT"
            ),
            h("div",{style:{display:"flex",gap:10}},
              h(Btn,{onClick:()=>{navigator.clipboard.writeText("Hi "+form.name+",

Welcome to True Balance Fitness!

1. Subscribe at: [YOUR STRIPE LINK]
2. Open the app: [YOUR APP URL]
3. On iPhone: tap Share → Add to Home Screen
4. Sign up with email: "+form.email+"
5. Create your password when prompted

See you soon!
— Anthony Anderson, CPT");},color:C.teal,full:true},"Copy Invitation"),
